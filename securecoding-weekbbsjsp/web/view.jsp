    ...
    <div class="row">
        <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tr>
                ...
                <td colspan="2"><%= board.getBoardTitle() %> <!-- Special character not handling -->
                </td>
            </tr>
            <tr>
                <td>Author</td>
            ...
            <tr>
                <td>Contents</td>
                <td colspan="2"
                    style="text-align: left;"><%= board.getBoardContent() %> <!-- Special character not handling -->
                </td>
            </tr>
            </tbody>
        </table>
        <a href="board.jsp" class="btn btn-success">Go back</a>
        <%
